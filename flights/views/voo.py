...
from flights.forms import VooForm
from flights.models import Voo
from flights.services import ReservaService
from .mixins import StaffRequiredMixin


class VooListView(LoginRequiredMixin, ListView):
    model = Voo
    template_name = 'flights/voo_list.html'
...
class VooDetailView(LoginRequiredMixin, DetailView):
    model = Voo
    template_name = 'flights/voo_detail.html'
...
class VooCreateView(StaffRequiredMixin, SuccessMessageMixin, CreateView):
    model = Voo
    form_class = VooForm
    template_name = 'flights/voo_form.html'
...
class VooDeleteView(StaffRequiredMixin, DeleteView):
    model = Voo
    template_name = 'flights/voo_confirm_delete.html'
    success_url = reverse_lazy('voo-list')

    def form_valid(self, form):
        messages.success(self.request, 'Voo excluído com sucesso!')
